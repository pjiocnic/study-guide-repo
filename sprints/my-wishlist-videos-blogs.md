...
- [5. Integrations](#5-integrations)
  - [5.1. EventBridge + ECS Fargate](#51-eventbridge--ecs-fargate)
- [6. Websockets](#6-websockets)
- [7. Event Bridge](#7-event-bridge)
  - [7.1. Event Routing](#71-event-routing)
  - [7.2. Schema Registry](#72-schema-registry)
  - [7.3. Private Endpoints as Targets](#73-private-endpoints-as-targets)
  - [7.4. ECS as Targets](#74-ecs-as-targets)
- [8. Lambda](#8-lambda)
  - [8.1. Secrets](#81-secrets)
...
## 7.3. Private Endpoints as Targets
