...
1. [Amazon S3 Examples Using the AWS SDK for Java](https://docs.aws.amazon.com/sdk-for-java/v1/developer-guide/examples-s3.html)
1. [S3 Java Examples from ServerlessLand](https://serverlessland.com/patterns?services=s3&framework=SAM&language=Java)
