...
- [2. ABAC](#2-abac)
- [3. Cross Account Role Pattern](#3-cross-account-role-pattern)
- [4. Organizations](#4-organizations)
- [5. courses](#5-courses)
- [6. Different Policy Types](#6-different-policy-types)
- [7. Examples](#7-examples)
- [8. Exam Prep](#8-exam-prep)
- [9. PassRole](#9-passrole)
- [10. Policy Types](#10-policy-types)
  - [10.1. Different Policy Types](#101-different-policy-types)
  - [10.2. Identity Based Policies](#102-identity-based-policies)
  - [10.3. Resource Based Policies](#103-resource-based-policies)
- [11. Permission Boundaries](#11-permission-boundaries)
  - [11.1. Demo - Permission Boundaries](#111-demo---permission-boundaries)
- [12. Roles](#12-roles)
  - [12.1. AssumeRoles](#121-assumeroles)
  - [12.2. Role Chaining](#122-role-chaining)
- [13. IAM Paths](#13-iam-paths)
- [14. Temporary Elevated Access](#14-temporary-elevated-access)
- [15. Session Tags](#15-session-tags)
- [16. Service linked Roles](#16-service-linked-roles)
- [17. Service Control Policies](#17-service-control-policies)
- [18. SkillBuilder Courses](#18-skillbuilder-courses)
- [19. Trust Policies](#19-trust-policies)
...
## 10.1. Different Policy Types

1. [IAM policy types: How and when to use them by Matt Luttrell and Josh Joy](https://aws.amazon.com/blogs/security/iam-policy-types-how-and-when-to-use-them/)

## 10.2. Identity Based Policies
...
## 11.1. Demo - Permission Boundaries
...
# 17. Service Control Policies

1. [How to Use Service Control Policies in AWS Organizations by Frank Phillis](https://aws.amazon.com/blogs/security/how-to-use-service-control-policies-in-aws-organizations/)

# 18. SkillBuilder Courses
