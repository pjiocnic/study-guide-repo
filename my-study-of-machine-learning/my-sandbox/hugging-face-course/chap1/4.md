...
<img class="block dark:hidden" src="images/transformers_chrono.svg" alt="A brief chronology of Transformers models.">
<img class="hidden dark:block" src="images/transformers_chrono-dark.svg" alt="A brief chronology of Transformers models.">
</div>
...
<div class="flex justify-center">
<img class="block dark:hidden" src="images/causal_modeling.svg" alt="Example of causal language modeling in which the next word from a sentence is predicted.">
<img class="hidden dark:block" src="images/causal_modeling-dark.svg" alt="Example of causal language modeling in which the next word from a sentence is predicted.">
</div>

Another example is *masked language modeling*, in which the model predicts a masked word in the sentence.

<div class="flex justify-center">
<img class="block dark:hidden" src="images/masked_modeling.svg" alt="Example of masked language modeling in which a masked word from a sentence is predicted.">
<img class="hidden dark:block" src="images/masked_modeling-dark.svg" alt="Example of masked language modeling in which a masked word from a sentence is predicted.">
</div>
...
<div class="flex justify-center">
<img src="images/model_parameters.png" alt="Number of parameters of recent Transformers models" width="90%">
</div>
...
<div class="flex justify-center">
<img class="block dark:hidden" src="images/carbon_footprint.svg" alt="The carbon footprint of a large language model.">
<img class="hidden dark:block" src="images/carbon_footprint-dark.svg" alt="The carbon footprint of a large language model.">
</div>

[Watch on YouTube](https://www.youtube.com/watch?v=ftWlj4FBHTg)
...
[Watch on YouTube](https://www.youtube.com/watch?v=BqqfQnyjmgg)

*Pretraining* is the act of training a model from scratch: the weights are randomly initialized, and the training starts without any prior knowledge.

<div class="flex justify-center">
<img class="block dark:hidden" src="images/pretraining.svg" alt="The pretraining of a language model is costly in both time and money.">
<img class="hidden dark:block" src="images/pretraining-dark.svg" alt="The pretraining of a language model is costly in both time and money.">
</div>
...
<div class="flex justify-center">
<img class="block dark:hidden" src="images/transformers_blocks.svg" alt="Architecture of a Transformers models">
</div>
...
<div class="flex justify-center">
<img class="block dark:hidden" src="images/transformers.svg" alt="Architecture of a Transformers models">
</div>
