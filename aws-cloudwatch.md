...
- [3. Customize Alarms](#3-customize-alarms)
- [4. Examples](#4-examples)
- [5. Insights](#5-insights)
- [6. Custom Metrics](#6-custom-metrics)
- [7. Building Dashboards using CDK](#7-building-dashboards-using-cdk)
  - [7.1. Building Dashboards for DocumentDB](#71-building-dashboards-for-documentdb)
- [8. Pricing](#8-pricing)
- [9. Videos](#9-videos)
- [10. Tutorials](#10-tutorials)
- [11. Workshops](#11-workshops)
- [12. Subscription filters](#12-subscription-filters)
...
# 7. Building Dashboards using CDK
...
## 7.1. Building Dashboards for DocumentDB
