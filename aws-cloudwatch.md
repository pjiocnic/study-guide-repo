...
3. [[dk-patterns/serverless] The CloudWatch Dashboard](https://github.com/cdk-patterns/serverless/blob/main/the-cloudwatch-dashboard/README.md)
4. [CloudWatch Dashboard for API Gateway using CDK](https://github.com/aws-samples/aws-cdk-apigateway-cloudwatch-dashboard)
5. [AWS Dashboards with AWS CDK in TypeScript](https://levelup.gitconnected.com/aws-dashboards-with-aws-cdk-in-typescript-12d97bf0958)
6. [AWS CloudTrail Log Monitoring](https://catalog.us-east-1.prod.workshops.aws/workshops/2e48b9fc-f721-4417-b811-962b7f31b61c/en-US/cleanup)
