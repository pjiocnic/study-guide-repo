...
- [8. Core Topics](#8-core-topics)
  - [8.1. Throttling](#81-throttling)
  - [8.2. Error Handling](#82-error-handling)
    - [8.2.1. Exponential backoff and jitter algorithm](#821-exponential-backoff-and-jitter-algorithm)
- [9. Cloudwatch Insights](#9-cloudwatch-insights)
- [10. Extensions](#10-extensions)
- [11. Devops](#11-devops)
- [12. Development](#12-development)
  - [12.1. Compilation techniques](#121-compilation-techniques)
  - [12.2. Designing](#122-designing)
  - [12.3. Java](#123-java)
  - [12.4. SAM](#124-sam)
  - [12.5. Snapstart](#125-snapstart)
  - [12.6. Code organization](#126-code-organization)
- [13. Event Source Mapping](#13-event-source-mapping)
  - [13.1. Core](#131-core)
  - [13.2. Filtering](#132-filtering)
  - [13.3. FIFO SQS as Event Source](#133-fifo-sqs-as-event-source)
  - [13.4. Kinesis](#134-kinesis)
- [14. Function URLs](#14-function-urls)
- [15. Integration with AWS Services](#15-integration-with-aws-services)
  - [15.1. ECS](#151-ecs)
  - [15.2. CloudFront](#152-cloudfront)
  - [15.3. Kafka](#153-kafka)
  - [15.4. Parameter store](#154-parameter-store)
  - [15.5. S3](#155-s3)
  - [15.6. Secrets-Manager](#156-secrets-manager)
  - [15.7. SNS](#157-sns)
  - [15.8. SQS](#158-sqs)
- [16. Invocation Models](#16-invocation-models)
- [17. Kinesis](#17-kinesis)
- [18. Layers](#18-layers)
- [19. Observability](#19-observability)
- [20. Plot pricing](#20-plot-pricing)
- [21. Skillbuilder Courses](#21-skillbuilder-courses)
- [22. Scaling and concurrency in Lambda](#22-scaling-and-concurrency-in-lambda)
  - [22.1. Core Concepts](#221-core-concepts)
  - [22.2. Provisioned Concurrency](#222-provisioned-concurrency)
  - [22.3. Devops](#223-devops)
  - [22.4. Concurrency Controls and Quotas](#224-concurrency-controls-and-quotas)
  - [22.5. Max Concurrency](#225-max-concurrency)
  - [22.6. Throttling](#226-throttling)
- [23. Comparison between REST and GraphQL API architectures](#23-comparison-between-rest-and-graphql-api-architectures)
- [24. RDSProxy](#24-rdsproxy)
- [25. Security](#25-security)
  - [25.1. Lambda Security Using Resource Policy / ExecutionRole](#251-lambda-security-using-resource-policy--executionrole)
  - [25.2. Lambda Authorizers](#252-lambda-authorizers)
  - [25.3. Using Cognito to secure Lambda's function URL](#253-using-cognito-to-secure-lambdas-function-url)
- [26. Testing](#26-testing)
- [27. Tooling](#27-tooling)
- [28. Stream Event Sources](#28-stream-event-sources)
- [29. User Stories](#29-user-stories)
- [30. How to use Spring with Lambda?](#30-how-to-use-spring-with-lambda)
- [31. Networking](#31-networking)
  - [31.1. VPC-Enabled Lambda](#311-vpc-enabled-lambda)
    - [31.1.1. Deploying to a VPC](#3111-deploying-to-a-vpc)
- [32. Troubleshooting](#32-troubleshooting)
- [33. Tracing](#33-tracing)
- [34. Well Architected](#34-well-architected)
  - [34.1. Series TOC](#341-series-toc)
  - [34.2. Controlling serverless API access](#342-controlling-serverless-api-access)
  - [34.3. Security](#343-security)
  - [34.4. Service Quotas / Scaling / Concurrency](#344-service-quotas--scaling--concurrency)
  - [34.5. Event Driven](#345-event-driven)
  - [34.6. How to secure workloads with public endpoints](#346-how-to-secure-workloads-with-public-endpoints)
  - [34.7. Serverless Lens](#347-serverless-lens)
- [35. Cross-account access](#35-cross-account-access)
- [36. Powertools](#36-powertools)
  - [36.1. Java](#361-java)
  - [36.2. Typescript](#362-typescript)
- [37. Batch Processing](#37-batch-processing)
  - [37.1. Checkpointing](#371-checkpointing)
- [38. Staging](#38-staging)
- [39. Cookbooks](#39-cookbooks)
  - [39.1. Cookbook by Ran Isenberg](#391-cookbook-by-ran-isenberg)
- [40. DLQs](#40-dlqs)
- [41. Monitoring](#41-monitoring)
- [42. Workshops](#42-workshops)
- [43. Videos](#43-videos)
- [44. Function URLs](#44-function-urls)
- [45. Use cases](#45-use-cases)
  - [45.1. Aggregating Data](#451-aggregating-data)
- [46. Curate](#46-curate)
...
### 8.2.1. Exponential backoff and jitter algorithm
...
# 23. Comparison between REST and GraphQL API architectures
...
## 25.1. Lambda Security Using Resource Policy / ExecutionRole
...
## 25.3. Using Cognito to secure Lambda's function URL
...
# 30. How to use Spring with Lambda?
...
## 34.2. Controlling serverless API access
...
## 34.4. Service Quotas / Scaling / Concurrency
...
## 34.6. How to secure workloads with public endpoints
