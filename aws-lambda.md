...
- [3. Skillbuilder Courses](#3-skillbuilder-courses)
- [4. Core Topics](#4-core-topics)
  - [4.1. Throttling](#41-throttling)
  - [4.2. Error Handling](#42-error-handling)
    - [4.2.1. Exponential backoff and jitter algorithm](#421-exponential-backoff-and-jitter-algorithm)
...
- [8. Development](#8-development)
  - [8.1. Compilation techniques](#81-compilation-techniques)
  - [8.2. Designing](#82-designing)
  - [8.3. Java](#83-java)
  - [8.4. SAM](#84-sam)
  - [8.5. Snapstart](#85-snapstart)
  - [8.6. Code organization](#86-code-organization)
- [9. Event Source Mapping](#9-event-source-mapping)
  - [9.1. Core](#91-core)
  - [9.2. Filtering](#92-filtering)
  - [9.3. FIFO SQS as Event Source](#93-fifo-sqs-as-event-source)
  - [9.4. Kinesis](#94-kinesis)
- [10. Scaling and concurrency in Lambda](#10-scaling-and-concurrency-in-lambda)
  - [10.1. Core Concepts](#101-core-concepts)
  - [10.2. Provisioned Concurrency](#102-provisioned-concurrency)
  - [10.3. Devops](#103-devops)
  - [10.4. Concurrency Controls and Quotas](#104-concurrency-controls-and-quotas)
  - [10.5. Max Concurrency](#105-max-concurrency)
  - [10.6. Throttling](#106-throttling)
- [11. Invocation Models](#11-invocation-models)
- [12. Comparison between REST and GraphQL API architectures](#12-comparison-between-rest-and-graphql-api-architectures)
- [13. RDSProxy](#13-rdsproxy)
- [14. Security](#14-security)
  - [14.1. Lambda Security Using Resource Policy / ExecutionRole](#141-lambda-security-using-resource-policy--executionrole)
  - [14.2. Lambda Authorizers](#142-lambda-authorizers)
  - [14.3. Using Cognito to secure Lambda's function URL](#143-using-cognito-to-secure-lambdas-function-url)
...
- [24. Cross-account access](#24-cross-account-access)
- [25. Powertools](#25-powertools)
  - [25.1. Java](#251-java)
  - [25.2. Typescript](#252-typescript)
- [26. Batch Processing](#26-batch-processing)
  - [26.1. Checkpointing](#261-checkpointing)
- [27. Staging](#27-staging)
- [28. VPC-Enabled Lambda](#28-vpc-enabled-lambda)
- [29. Cookbooks](#29-cookbooks)
  - [29.1. Cookbook by Ran Isenberg](#291-cookbook-by-ran-isenberg)
- [30. DLQs](#30-dlqs)
- [31. Monitoring](#31-monitoring)
- [32. Workshops](#32-workshops)
- [33. Videos](#33-videos)
...
### 4.2.1. Exponential backoff and jitter algorithm
...
# 10. Scaling and concurrency in Lambda
...
# 12. Comparison between REST and GraphQL API architectures
...
## 14.1. Lambda Security Using Resource Policy / ExecutionRole
...
## 14.3. Using Cognito to secure Lambda's function URL
