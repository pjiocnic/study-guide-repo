...
- [9. Devops](#9-devops)
- [10. Function URLs](#10-function-urls)
- [11. Integration](#11-integration)
  - [11.1. ECS](#111-ecs)
  - [11.2. Kafka](#112-kafka)
  - [11.3. S3](#113-s3)
  - [11.4. Secrets-Manager](#114-secrets-manager)
  - [11.5. SNS](#115-sns)
  - [11.6. SQS](#116-sqs)
...
- [13. Invocation Models](#13-invocation-models)
- [14. Skillbuilder Courses](#14-skillbuilder-courses)
- [15. Scaling and concurrency in Lambda](#15-scaling-and-concurrency-in-lambda)
  - [15.1. Core Concepts](#151-core-concepts)
  - [15.2. Provisioned Concurrency](#152-provisioned-concurrency)
  - [15.3. Devops](#153-devops)
  - [15.4. Concurrency Controls and Quotas](#154-concurrency-controls-and-quotas)
  - [15.5. Max Concurrency](#155-max-concurrency)
  - [15.6. Throttling](#156-throttling)
- [16. Comparison between REST and GraphQL API architectures](#16-comparison-between-rest-and-graphql-api-architectures)
- [17. RDSProxy](#17-rdsproxy)
- [18. Security](#18-security)
  - [18.1. Lambda Security Using Resource Policy / ExecutionRole](#181-lambda-security-using-resource-policy--executionrole)
  - [18.2. Lambda Authorizers](#182-lambda-authorizers)
  - [18.3. Using Cognito to secure Lambda's function URL](#183-using-cognito-to-secure-lambdas-function-url)
- [19. Testing](#19-testing)
- [20. Stream Event Sources](#20-stream-event-sources)
- [21. User Stories](#21-user-stories)
- [22. How to use Spring with Lambda?](#22-how-to-use-spring-with-lambda)
- [23. Networking](#23-networking)
- [24. Troubleshooting](#24-troubleshooting)
- [25. Tracing](#25-tracing)
- [26. Well Architected](#26-well-architected)
  - [26.1. Series TOC](#261-series-toc)
  - [26.2. Controlling serverless API access](#262-controlling-serverless-api-access)
  - [26.3. Security](#263-security)
  - [26.4. Service Quotas / Scaling / Concurrency](#264-service-quotas--scaling--concurrency)
  - [26.5. Event Driven](#265-event-driven)
  - [26.6. How to secure workloads with public endpoints](#266-how-to-secure-workloads-with-public-endpoints)
  - [26.7. Serverless Lens](#267-serverless-lens)
- [27. Cross-account access](#27-cross-account-access)
- [28. Powertools](#28-powertools)
  - [28.1. Java](#281-java)
  - [28.2. Typescript](#282-typescript)
- [29. Batch Processing](#29-batch-processing)
  - [29.1. Checkpointing](#291-checkpointing)
- [30. Staging](#30-staging)
- [31. VPC-Enabled Lambda](#31-vpc-enabled-lambda)
- [32. Cookbooks](#32-cookbooks)
  - [32.1. Cookbook by Ran Isenberg](#321-cookbook-by-ran-isenberg)
- [33. DLQs](#33-dlqs)
...
# 15. Scaling and concurrency in Lambda
...
# 16. Comparison between REST and GraphQL API architectures
...
## 18.1. Lambda Security Using Resource Policy / ExecutionRole
...
## 18.3. Using Cognito to secure Lambda's function URL
...
# 22. How to use Spring with Lambda?
...
## 26.2. Controlling serverless API access
...
## 26.4. Service Quotas / Scaling / Concurrency
...
## 26.6. How to secure workloads with public endpoints
