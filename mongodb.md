...
- [10. Spring boot and docker](#10-spring-boot-and-docker)
- [11. JOINs and Aggregations](#11-joins-and-aggregations)
- [12. Versioning](#12-versioning)
- [13. Optimistic Locking](#13-optimistic-locking)
- [14. DocumentDB vs MongoDB](#14-documentdb-vs-mongodb)
- [15. Schema Validation](#15-schema-validation)
- [16. Aggregations](#16-aggregations)
- [17. Tools](#17-tools)
- [18. VSCode](#18-vscode)
- [19. Sample Data](#19-sample-data)
- [20. Books](#20-books)
- [21. Courses](#21-courses)
- [22. Docker](#22-docker)
- [23. Schema Validation](#23-schema-validation)
  - [23.1. Validation using Java](#231-validation-using-java)
  - [23.2. Schema validation for polymorphic schemas](#232-schema-validation-for-polymorphic-schemas)
  - [23.3. Curate](#233-curate)
- [24. Staging](#24-staging)
- [25. MongoDB Shows](#25-mongodb-shows)
  - [25.1. [Migrating Stored Procedures to MongoDB](https://www.youtube.com/watch?v=Bog0aIGHG0A) By Vittal Pai @B'lore](#251-migrating-stored-procedures-to-mongodbhttpswwwyoutubecomwatchvbog0aighg0a-by-vittal-pai-blore)
...
## 23.2. Schema validation for polymorphic schemas
...
## 25.1. [Migrating Stored Procedures to MongoDB](https://www.youtube.com/watch?v=Bog0aIGHG0A) By Vittal Pai @B'lore
