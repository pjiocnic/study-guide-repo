...
public class AppProperties {
    ...
    public static class Output {
        ...
        /**
         * If true, do not upload to S3. Save gzip files locally to localDir.
         */
        private boolean dryRun = false;

        /**
         * Local directory for dry-run outputs.
         */
        private String localDir = "out/";

        /**
         * Optional fixed CSV columns order (comma-separated). If blank, header is inferred.
         */
