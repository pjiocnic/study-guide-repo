...
resource "aws_lambda_function" "fn" {
  ...
  runtime       = "java17"
  filename      = "${path.module}/../target/lambda-config-sample-0.0.1-shaded.jar"
  source_code_hash = filebase64sha256("${path.module}/../target/lambda-config-sample-0.0.1-shaded.jar")
