...
- [5. Integration](#5-integration)
  - [5.1. ECS](#51-ecs)
  - [5.2. Glue](#52-glue)
  - [5.3. DynamoDBStreams](#53-dynamodbstreams)
- [6. Patterns](#6-patterns)
  ...
  - [6.4. Content enrichment pattern](#64-content-enrichment-pattern)
  - [6.5. Claim Check Pattern](#65-claim-check-pattern)
...
## 6.4. Content enrichment pattern
