...
- [3. Config](#3-config)
- [4. EC2-Spot-Instances-Labs](#4-ec2-spot-instances-labs)
- [5. Eventbridge,Orchestrator](#5-eventbridgeorchestrator)
- [6. ECS,Spring](#6-ecsspring)
- [7. ECS,Lambda,SQS](#7-ecslambdasqs)
- [8. ECS,EventBridge](#8-ecseventbridge)
- [9. DynamoDB,ECS,EventBridge,Lambda,SNS,SQS](#9-dynamodbecseventbridgelambdasnssqs)
- [10. Lambda](#10-lambda)
...
# 9. DynamoDB,ECS,EventBridge,Lambda,SNS,SQS
